...
// in gonggoo_app/test/auth/auth_provider_test.dart.
...
import 'package:gonggoo_app/features/auth/models/user_model.dart' as _i2;
...
class MockAuthRepository extends _i1.Mock implements _i4.AuthRepository {
  ...
  @override
  _i5.Stream<_i3.User?> get userChanges =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.UserModel?> getUserModelFromFirestore(String? uid) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.UserModel> setPhoneVerified({
    required String? uid,
    required bool? verified,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#setPhoneVerified, [], {
              #uid: uid,
              #verified: verified,
            }),
            returnValue: _i5.Future<_i2.UserModel>.value(
...
/// A class which mocks [AuthIntegrityService].
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthIntegrityService extends _i1.Mock
    implements _i7.AuthIntegrityService {
  MockAuthIntegrityService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  void startPeriodicChecks({Duration? interval = const Duration(hours: 24)}) =>
      super.noSuchMethod(
        Invocation.method(#startPeriodicChecks, [], {#interval: interval}),
        returnValueForMissingStub: null,
      );

  @override
  void stopPeriodicChecks() => super.noSuchMethod(
    Invocation.method(#stopPeriodicChecks, []),
    returnValueForMissingStub: null,
  );

  @override
  _i5.Future<void> logAuthError({
    ...
    Map<String, dynamic>? additionalData,
      ...
      (super.noSuchMethod(
            Invocation.method(#logAuthError, [], {
              #operation: operation,
  ...
  @override
  _i5.Future<Map<String, dynamic>> performIntegrityCheck({
    bool? autoFix = true,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#performIntegrityCheck, [], {#autoFix: autoFix}),
  ...
  @override
  _i5.Future<Map<String, dynamic>> adminCheckAllUsers() =>
      (super.noSuchMethod(
            Invocation.method(#adminCheckAllUsers, []),
            returnValue: _i5.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
